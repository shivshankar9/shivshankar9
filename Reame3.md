# 🚀 **Shiv Shankar Kumar**  
_**AI Engineer | Full Stack Developer | MCA Student @ Amity University**_  
Coding the impossible... one bug at a time. 💻  
**AI Engineer by day**, **Meme Lord by night**. 🎮

---

### 🤪 **About Me**  
I’m not just a developer, I’m an **exception handler** for life.  
I write code, fix bugs, crack jokes, and build **AI models**—because why not? 😎  
Currently **specialized in AI/ML** in my **MCA**, working towards **building smarter systems**.  
I believe in writing clean code **unless it's 3 AM and I'm racing the deadline**. 🕒  
Tech stack? I got you covered: **React**, **Spring Boot**, **Java**, **JavaScript**, **ML**, **AI**, **Tauri**, **SQLite**, and even **Gradle**. (Basically everything... except sleep). 😴  
...
![Employee Meme](https://media.giphy.com/media/26tP4LS
